...
import { FaSpinner, FaUserGraduate, FaComments, FaCalendarAlt, FaSmile, FaFrown, FaMeh } from 'react-icons/fa';

const NonAcademicFeedbackList = () => {
  const dispatch = useDispatch();
  const { feedbacks, loading, error } = useSelector((state) => state.nonAcademic);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center p-4 bg-white rounded-full shadow-lg mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Administrative Feedback</h1>
          </div>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Student feedback about administrative services and support
          </p>
        </div>
        ...
        {!loading && !error && feedbacks.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 bg-white rounded-2xl shadow-lg">
            ...
            <p className="text-gray-600 text-center max-w-md">
              It looks like there are no feedback submissions about administrative services yet.
            </p>
          </div>
        )}
