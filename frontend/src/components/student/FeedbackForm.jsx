          ...
          <div className="mb-6 animate-fade-in-up">
            <div className="p-4 bg-green-50 border border-green-200 rounded-xl shadow-sm flex items-center">
              ...
              <div>
                ...
                <p className="text-green-600 text-sm">Thank you for your valuable input.</p>
              </div>
            </div>
          </div>
        )}
                      ...
                      >
                        {selectedQuestionnaire ? (
                          <div className="flex items-center gap-3">
                            ...
                            <span className="font-medium">{selectedQuestionnaire.title}</span>
                          </div>
                        ) : (
                          <span className="text-gray-500">Select questionnaire...</span>
                        )}
                          ...
                          <div className="py-1">
                            {loading ? (
                              ...
                              questionnaires.map((q) => (
                                <div
                                  ...
                                  className={`px-4 py-3 cursor-pointer hover:bg-gray-50 ${
                                    selectedQuestionnaire?.id === q.id ? 'bg-blue-50' : ''
                                  }`}
                                  onClick={() => handleQuestionnaireSelect(q, setFieldValue)}
                                >
                                  <div className="flex items-center gap-3">
                              ...
                              <div className="px-4 py-3 text-center text-gray-500">
                                ...
                                <p className="text-sm">No questionnaires available</p>
                              </div>
                            )}
                          </div>
                        </div>
                        ...
                        {selectedQuestionnaire.questions.map((question, index) => (
                          <div key={index} className="bg-white rounded p-3 border border-blue-100">
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                <p className="text-sm text-gray-800">{question.text || question}</p>
                                {question.type && (
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-6">
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <p className="text-sm text-gray-600">
              All submissions are completely anonymous. No personal data is stored.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            ...
            <p className="text-sm text-gray-600">
              Your input helps us improve services and create better experiences for everyone.
            </p>
          </div>
        </div>
      </div>
